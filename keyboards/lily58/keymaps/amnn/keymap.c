...
[_RAISE] = LAYOUT(
   _______, _______, KC_0,    KC_0,    KC_0,    _______,                            _______, _______, _______, _______, _______, _______,
   _______, KC_PLUS, KC_1,    KC_2,    KC_3,    KC_MINS,                            _______, _______, _______, _______, _______, _______,
   _______, KC_ASTR, KC_4,    KC_5,    KC_6,    KC_SLSH,                            _______, _______, _______, _______, _______, _______,
   _______, KC_CIRC, KC_7,    KC_8,    KC_9,    KC_PERC, _______,          _______, _______, _______, _______, _______, _______, _______,
                              _______, _______, _______, _______,          _______, _______, _______, _______
),
